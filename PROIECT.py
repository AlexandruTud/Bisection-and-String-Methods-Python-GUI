...
def my_bisection(f, a, b, tol):
    ...
    if np.sign(f(a)) == np.sign(f(b)):
        show_error("Eroare","Scalarii a si b nu delimiteaza o radacina!")  # Ridicăm o excepție generală
...
def errors():
    ...
    if not a.isdigit() or not b.isdigit():
        show_error("Eroare", "Introduceti doar numere pentru a si b!")
        return
    ...
    try:
        ...
        show_error("Eroare", "Expresia introdusa nu este o functie matematica valida!")
        return
